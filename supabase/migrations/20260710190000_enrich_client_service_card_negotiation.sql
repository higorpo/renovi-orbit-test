-- Enrich client service list cards: aggregate multiple chats/proposals per service request.
...
comment on function public.project_service_row(uuid, uuid) is
  'Builds unified service JSON. Client negotiation includes aggregate chat/proposal counts; provider my_proposal uses highest version.';
