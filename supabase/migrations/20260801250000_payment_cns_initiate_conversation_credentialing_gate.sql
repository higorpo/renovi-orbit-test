-- Payment Task 27: provider credentialing gate (design.md §4.1.1, Req 29).
-- Baseline: docs/payment-system/rpc-dumps/cns_initiate_conversation.sql @ 20260723120000
...
comment on function public.cns_initiate_conversation(uuid, uuid) is
  'Provider-only explicit chat create/get without message; rpc_idempotency_records replay (chats.initiate_conversation).';
