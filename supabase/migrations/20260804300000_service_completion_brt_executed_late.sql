-- Service completion Task 30: BRT date-only helpers for temporal gates (design §5.4.1).
-- Used by SERVICE_NOT_YET_DUE (mark_executed) and auto-mark grace (scheduled_end_at).
