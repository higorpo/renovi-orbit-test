-- Include suggested equipment/materials in get_service / list_services request payload.
...
begin
  ...
  return jsonb_build_object(
    ...
    'request', jsonb_build_object(
      ...
      'tags', coalesce(v_sr.tags, '{}'::text[]),
      'scope_complexity', v_sr.scope_complexity,
      'estimated_duration_hint', v_sr.estimated_duration_hint,
      'missing_info_warnings', coalesce(v_sr.missing_info_warnings, '{}'::text[]),
