-- Extend get_conversation_detail with accepted proposal summary for chat details panel.
-- Based on deployed get_conversation_detail (20260701105700) as introspected from local DB.
...
comment on function public.get_conversation_detail(uuid) is
  'Participant header snapshot: counterparty, masked address, service/category, SR photos, optional accepted proposal summary (R5-AC02).';
