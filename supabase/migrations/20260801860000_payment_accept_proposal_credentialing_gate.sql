-- Payment: require ACTIVE NetCred onboarding before any proposal acceptance.
-- Closes gap where non-credentialed providers could be accepted via the 3-arg wrapper.
