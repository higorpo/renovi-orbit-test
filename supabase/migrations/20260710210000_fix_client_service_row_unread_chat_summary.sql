-- Prioritize unread chats when picking client negotiation chat summary in project_service_row.
...
comment on function public.project_service_row(uuid, uuid) is
  'Builds unified service JSON. Client negotiation chat summary prefers unread chats, then latest inbound message.';
