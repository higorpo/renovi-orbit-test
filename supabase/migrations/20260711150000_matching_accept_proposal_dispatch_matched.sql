-- Matching M14c — accept_proposal DISPATCH_MATCHED terminal (design §4.4, §15.7).
...
comment on function public.accept_proposal(uuid, jsonb, uuid) is
  'Client accepts proposal; sets DISPATCH_MATCHED, revokes non-winner visibility, cancels matching MMD (M14c).';
