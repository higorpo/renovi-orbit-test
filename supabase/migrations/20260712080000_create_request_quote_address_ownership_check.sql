-- Enforce client_addresses ownership in create_request_quote_service_request (IDOR fix).
...
comment on function public.create_request_quote_service_request(
  ...
  'Inserts OPEN service_request after verifying address ownership; commits request_quote.create_order idempotency (service_role via Edge).';
