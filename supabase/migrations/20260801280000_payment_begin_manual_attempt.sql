-- Payment Task 30: payment_begin_manual_attempt RPC (design.md §4.11).
...
begin
  ...
  -- FAILED_PERMANENT allows explicit client-initiated manual retry after all automatic attempts.
...
comment on function public.payment_begin_manual_attempt(uuid, uuid, text, text, uuid) is
  'Manual charge lease: T-12h gate via payment_service_execution_at, increments manual_attempt_count.';
