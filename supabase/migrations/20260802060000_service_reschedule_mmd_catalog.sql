-- Service reschedule MMD templates + routing.
...
values
  (
    ...
    'push',
    'Reagendamento solicitado — {{service_request_title}}',
    '{{requester_name}} solicitou o reagendamento do serviço {{service_request_title}}.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"requester_name":{"type":"string"},"current_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    'service.reschedule_requested',
    'email',
    'Reagendamento solicitado — {{service_request_title}}',
    '<p><strong>{{requester_name}}</strong> solicitou o reagendamento do serviço <strong>{{service_request_title}}</strong>.</p><p>Data atual: {{current_execution_formatted}}</p><p><a href="{{deep_link_path}}">Abrir conversa</a></p>',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"requester_name":{"type":"string"},"current_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    ...
    'push',
    'Nova data proposta — {{service_request_title}}',
    'O prestador propôs uma nova data para {{service_request_title}}: {{proposed_execution_formatted}}.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"proposed_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","proposed_execution_formatted","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    'service.reschedule_proposed',
    'email',
    'Nova data proposta — {{service_request_title}}',
    '<p>O prestador propôs uma nova data para <strong>{{service_request_title}}</strong>.</p><p>Nova data: <strong>{{proposed_execution_formatted}}</strong></p><p><a href="{{deep_link_path}}">Revisar no chat</a></p>',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"proposed_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","proposed_execution_formatted","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    ...
    'push',
    'Ajuste solicitado — {{service_request_title}}',
    'O cliente pediu ajuste na data proposta para {{service_request_title}}.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    'service.reschedule_cancelled',
    'push',
    'Reagendamento encerrado — {{service_request_title}}',
    'A solicitação de reagendamento foi encerrada. A data atual permanece válida.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    'service.reschedule_accepted',
    'push',
    'Reagendamento confirmado — {{service_request_title}}',
    'Nova data confirmada: {{proposed_execution_formatted}}.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"proposed_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","proposed_execution_formatted"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    'service.reschedule_accepted',
    'email',
    'Reagendamento confirmado — {{service_request_title}}',
    '<p>O reagendamento de <strong>{{service_request_title}}</strong> foi confirmado.</p><p>Nova data: <strong>{{proposed_execution_formatted}}</strong></p><p><a href="{{deep_link_path}}">Ver serviço</a></p>',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"proposed_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","proposed_execution_formatted","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    ...
    'push',
    'Reagendamento confirmado — {{service_request_title}}',
    'O cliente confirmou a nova data: {{proposed_execution_formatted}}.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"proposed_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","proposed_execution_formatted"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    ...
    'email',
    'Reagendamento confirmado — {{service_request_title}}',
    '<p>O cliente confirmou a nova data para <strong>{{service_request_title}}</strong>.</p><p>Nova data: <strong>{{proposed_execution_formatted}}</strong></p><p><a href="{{deep_link_path}}">Ver serviço</a></p>',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"proposed_execution_formatted":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","proposed_execution_formatted","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  ),
  (
    ...
    'push',
    'Lembrete de reagendamento — {{service_request_title}}',
    'Há uma solicitação de reagendamento aguardando sua proposta de nova data.',
    '{"type":"object","properties":{"contracted_service_id":{"type":"string"},"service_request_title":{"type":"string"},"deep_link_path":{"type":"string"}},"required":["service_request_title","deep_link_path"],"additionalProperties":true}'::jsonb,
    true
  )
...
comment on function public.mmd_ingest_event(text, uuid, text, jsonb, jsonb) is
  'Platform → MMD bridge: CNS + payment + service reschedule lifecycle events.';
