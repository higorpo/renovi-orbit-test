-- Notify losing providers in chat when the client accepts another proposal.
...
comment on function public.accept_proposal(uuid, jsonb, uuid) is
  'Atomic accept cascade: proposal ACCEPTED, SR COMPLETED, contracted service row; closes competing chats with a SYSTEM notice; winning provider chat stays ACTIVE.';
