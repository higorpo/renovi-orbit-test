-- Mask service request address for providers until their proposal is ACCEPTED.
...
comment on function public.project_service_row(uuid, uuid) is
  'Builds unified service JSON. Provider viewers see masked address until their proposal is ACCEPTED; client negotiation chat summary prefers unread chats.';
