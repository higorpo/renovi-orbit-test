-- payment_write_audit expects p_actor as payment_audit_actor enum, not text.
...
begin
  ...
  perform public.payment_write_audit(
    ...
    p_actor := case
      when v_initiator = 'client'::public.payment_attempt_initiator
        then 'client'::public.payment_audit_actor
      else 'cron'::public.payment_audit_actor
    end,
