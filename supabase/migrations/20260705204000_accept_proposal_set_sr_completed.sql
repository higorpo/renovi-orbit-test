-- Set service_requests to COMPLETED on proposal accept; keep winning provider chat ACTIVE.
...
comment on function public.accept_proposal(uuid, jsonb, uuid) is
  'Atomic accept cascade: proposal ACCEPTED, SR COMPLETED, contracted services row; closes competing chats only; winning provider chat stays ACTIVE.';
