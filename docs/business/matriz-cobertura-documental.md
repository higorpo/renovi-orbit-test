...
| settings | Hub settings `/dashboard/settings/*`; portfólio; área; exclusão; embute cartões + histórico; host Ganhos | OK (`configuracoes.md` + cross-link payments/earnings) | Sim (21) | Impacto legal de exclusão de conta; deep_link SQL legado `/dashboard/conta` | **OK** |
