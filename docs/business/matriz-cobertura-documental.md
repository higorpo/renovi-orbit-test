...
| provider-kyc | Gate de **conteúdo** até `ACTIVE` (menu completo); wizard Fase 3; BankPicker FEBRABAN; upload Option A; e-mail ops | OK (`gate-e-acesso-operacional.md`, `formulario-credenciamento-wizard.md`) | Sim (20) | — | **OK** |
