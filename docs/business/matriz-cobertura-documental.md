...
| my-services | Shell compartilhado; slot por role; abas/filtros RPC; deep link; sheet compare/history; card pipeline; highlight `PENDING_PAYMENT` / `FAILED_PERMANENT`; follow-up conclusão pós-data-fim / `EXECUTED` | OK (`solicitacoes-do-cliente.md`, README §8–9) | Sim (22) | Dropdowns só da página carregada; aba Disputas vazia | **OK** |
