...
| **Total módulos no índice** `modulos/README.md` | **17** (inclui `service-reschedule` parcial; `payments` + `provider-kyc` + `provider-earnings`) |
| READMEs de módulo em `docs/business/modulos/` | 17 (+ nota em `client-budgets/`) |
