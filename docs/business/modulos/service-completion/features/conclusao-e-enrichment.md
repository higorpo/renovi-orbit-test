...
| view-services | Host: CTAs na `ServiceContractedSection` (Public API; gate leve via `enrichmentReady` do modelo + contexto só no fluxo); `list_phase = dispute` quando CS `IN_DISPUTE` |
