...
| Host | `view-services` (`ServiceContractedSection`, `ServiceDetailPage`); `my-services` (sheets hospedados na página do card; aba Disputas); `RootLayout` (prompt global) — **só** imports da Public API |
