...
## 1. [ ] Create schema `message_dispatcher` and default privileges
...
—
## 2. [ ] Create enums `message_channel`, `message_dispatch_status`, `message_delivery_outcome`
...
Acceptance Criteria covered:
Req.2 AC3
## 3. [ ] Create table `message_templates`
...
Acceptance Criteria covered:
Req.2 AC1, Req.2 AC3
## 4. [ ] Create table `message_dispatches` (FSM authority)
...
Acceptance Criteria covered:
Req.5 AC1
## 5. [ ] Create table `message_dispatcher_user_limits`
...
Acceptance Criteria covered:
Req.1 AC3
## 6. [ ] Create table `message_dispatch_deliveries`
...
Acceptance Criteria covered:
Req.3 AC1
## 7. [ ] Create table `message_dispatcher_audit`
...
Acceptance Criteria covered:
Req.6 AC1
## 8. [ ] Create table `message_dispatcher_vendor_events`
...
Acceptance Criteria covered:
Req.6 AC2
## 9. [ ] Create partial indexes on `message_dispatches`
...
Acceptance Criteria covered:
Req.3 AC1, Req.6 AC3
## 10. [ ] Register `message_dispatcher` in Supabase API schema list
...
## 11. [ ] Implement `message_dispatch_status_allowed(from, to)` FSM matrix
...
Acceptance Criteria covered:
Req.4 AC3
## 12. [ ] Implement `message_dispatches_validate_transition()` BEFORE UPDATE trigger
...
Acceptance Criteria covered:
Req.4 AC3
## 13. [ ] Enable RLS on message_dispatches
...
Acceptance Criteria covered:
Design §3.8
## 14. [ ] Enable RLS on message_dispatcher_audit
...
Acceptance Criteria covered:
Req.6 AC1
## 15. [ ] Enable RLS on message_dispatch_deliveries
...
Acceptance Criteria covered:
Design §3.8
## 16. [ ] Enable RLS on message_templates
...
Acceptance Criteria covered:
Req.2 AC3
## 17. [ ] Seed platform_constants MMD keys
...
Acceptance Criteria covered:
Req.1 AC1 Req.7 AC3
## 18. [ ] Seed MVP message_templates rows
...
Acceptance Criteria covered:
Req.2 AC1 AC2
## 19. [ ] Create audit indexes dispatch_created profile_created
...
Acceptance Criteria covered:
Req.6 AC3
## 20. [ ] Document immutable fields operator runbook
...
## 21. [ ] Implement ingest: reject NULL `p_idempotency_key`
...
Acceptance Criteria covered:
Req.5 AC2
## 22. [ ] Implement ingest duplicate idempotency return
...
Acceptance Criteria covered:
Req.5 AC1
## 23. [ ] Implement ingest FOR UPDATE user_limits
...
Acceptance Criteria covered:
Req.1 AC3
## 24. [ ] Implement ingest: email 24h quota COUNT → terminal/canceled
...
Acceptance Criteria covered:
Req.1 AC1
## 25. [ ] Implement ingest push 24h quota
...
Acceptance Criteria covered:
Req.1 AC1
## 26. [ ] Implement ingest: push 20min cooldown → SCHEDULED reschedule
...
Acceptance Criteria covered:
Req.1 AC2
## 27. [ ] Implement ingest template channel validation
...
Acceptance Criteria covered:
Req.2 AC3
## 28. [ ] Implement ingest SCHEDULED vs QUEUED branching
...
Acceptance Criteria covered:
Req.4 AC1
## 29. [ ] Package message_dispatcher_ingest SECURITY DEFINER
...
Acceptance Criteria covered:
Design §11.1
## 30. [ ] Implement message_dispatcher_cancel cancelable states
...
Acceptance Criteria covered:
Req.4 AC2
## 31. [ ] Implement cancel 409 on PROCESSING DELIVERED
...
Acceptance Criteria covered:
Req.4 AC3
## 32. [ ] Grant cancel to authenticated owner
...
## 33. [ ] Implement activate_scheduled cron RPC
...
Acceptance Criteria covered:
Req.4 AC1
## 34. [ ] Implement evaluate_pending subroutine
...
Acceptance Criteria covered:
Req.4 AC1
## 35. [ ] Implement promote_retries RPC
...
Acceptance Criteria covered:
Req.7 AC1
## 36. [ ] Implement compute_next_retry_at helper
...
Acceptance Criteria covered:
Req.7 AC1
## 37. [ ] Implement `message_dispatcher_reclaim_leases` janitor RPC
...
Acceptance Criteria covered:
Req.3 AC3
## 38. [ ] Create audit_on_dispatch_update function
...
Acceptance Criteria covered:
Req.6 AC1
## 39. [ ] Attach AFTER UPDATE audit trigger
...
Acceptance Criteria covered:
Req.6 AC1
## 40. [ ] Schedule pg_cron mmd_activate_scheduled
...
## 41. [ ] Schedule pg_cron mmd_promote_retries
...
Acceptance Criteria covered:
Req.7 AC1
## 42. [ ] Schedule pg_cron mmd_reclaim_leases
...
Acceptance Criteria covered:
Req.3 AC3
## 43. [ ] Implement `message_dispatcher_checkout_batch` SKIP LOCKED CTE
...
Acceptance Criteria covered:
Req.3 AC1
## 44. [ ] Implement checkout atomic lease (`locked_until`, `locked_by`)
...
Acceptance Criteria covered:
Req.3 AC2
## 45. [ ] Implement checkout email auth.users resolution
...
Acceptance Criteria covered:
Design §2.6
## 46. [ ] Implement checkout no_email_on_file terminal
...
Acceptance Criteria covered:
Design §2.6
## 47. [ ] Implement checkout push fan-out INSERT deliveries
...
Acceptance Criteria covered:
Req.2 AC2
## 48. [ ] Implement checkout no_push_targets terminal
...
Acceptance Criteria covered:
Design §2.6
## 49. [ ] Implement checkout JSON DTO array response
...
Acceptance Criteria covered:
Req.5 AC3
## 50. [ ] Enforce max 10 devices per dispatch at checkout
...
Acceptance Criteria covered:
Design §9.2
## 51. [ ] Grant checkout EXECUTE service_role only
...
## 52. [ ] Scaffold message-dispatcher-worker Edge
...
Acceptance Criteria covered:
Design §5.5
## 53. [ ] Add worker to config.toml verify_jwt false
...
Acceptance Criteria covered:
Design §5.5
## 54. [ ] Implement worker auth DISPATCHER_CRON_SECRET
...
Acceptance Criteria covered:
Design §11.6
## 55. [ ] Wire worker checkout_batch call
...
Acceptance Criteria covered:
Req.3 AC1
## 56. [ ] Implement worker email Mustache or template render
...
Acceptance Criteria covered:
Req.2 AC1
## 57. [ ] Implement worker push JSON Schema validation
...
Acceptance Criteria covered:
Req.2 AC2
## 58. [ ] Implement worker Resend HTTP with `Idempotency-Key: correlation_id`
...
Acceptance Criteria covered:
Req.5 AC3
## 59. [ ] Implement worker FCM HTTP v1 per delivery
...
Acceptance Criteria covered:
Req.2 AC2 Req.5 AC3
## 60. [ ] Implement worker 25s HTTP timeout
...
## 61. [ ] Implement report_delivery_outcome success DELIVERED
...
Acceptance Criteria covered:
Req.6 AC2
## 62. [ ] Implement report guards locked_by status
...
Acceptance Criteria covered:
Req.3 AC1
## 63. [ ] Implement `report_delivery_outcome` retryable failure path
...
Acceptance Criteria covered:
Req.7 AC1
## 64. [ ] Implement report terminal failure path
...
Acceptance Criteria covered:
Req.7 AC2
## 65. [ ] Implement report max_retries force terminal
...
Acceptance Criteria covered:
Req.7 AC3
## 66. [ ] Implement beacon disable on invalid FCM token
...
Acceptance Criteria covered:
Req.7 AC2
## 67. [ ] Implement partial push fan-out parent DELIVERED
...
Acceptance Criteria covered:
Design §8.4
## 68. [ ] Wire worker HTTP classifier
...
Acceptance Criteria covered:
Req.7 AC1 AC2
## 69. [ ] Wire sequential report per dispatch
...
Acceptance Criteria covered:
Req.5 AC3
## 70. [ ] Schedule mmd_invoke_worker pg_net POST
...
## 71. [ ] Scaffold message-dispatcher-webhook-resend
...
Acceptance Criteria covered:
Design §5.6
## 73. [ ] Implement Resend HMAC verification
...
Acceptance Criteria covered:
Design §11.3
## 74. [ ] Implement `message_dispatcher_reconcile_vendor_event` RPC
...
Acceptance Criteria covered:
Req.6 AC2
## 75. [ ] Implement reconcile duplicate vendor_event noop
...
Acceptance Criteria covered:
Req.6 AC2
## 76. [ ] Implement reconcile delivered DELIVERED
...
Acceptance Criteria covered:
Req.6 AC2
## 77. [ ] Implement reconcile hard bounce terminal
...
Acceptance Criteria covered:
Req.7 AC2
## 78. [ ] Wire webhook to reconcile RPC
...
Acceptance Criteria covered:
Req.6 AC2
## 79. [ ] Integrate platform rateLimiter 120 min
...
Acceptance Criteria covered:
Design §11.4
## 80. [ ] Implement audit_timeline RPC
...
Acceptance Criteria covered:
Design §10.3
## 82. [ ] Document mmd metrics catalog
...
Acceptance Criteria covered:
Design §10.2
## 83. [ ] Optional message_dispatcher_stats table
...
Acceptance Criteria covered:
Design §10.2
## 84. [ ] SQL alerts queue lag terminal spike janitor
...
Acceptance Criteria covered:
Design §10.5
## 85. [ ] Dead-letter ops runbook FAILED_TERMINAL
...
Acceptance Criteria covered:
Design §8.3
## 88. [ ] Integration test lease orphan recovery
...
Acceptance Criteria covered:
Req.3 AC3
## 89. [ ] Integration test 429 retryable backoff
...
Acceptance Criteria covered:
Req.7 AC1
## 90. [ ] Integration test FCM bad token terminal
...
Acceptance Criteria covered:
Req.7 AC2
## 91. [ ] Integration test max_retries terminal
...
Acceptance Criteria covered:
Req.7 AC3
## 92. [ ] Integration test duplicate webhook
...
Acceptance Criteria covered:
Req.6 AC2
## 93. [ ] Integration test pg_net failure QUEUED persists
...
## 94. [ ] Audit RPC SECURITY DEFINER search_path
...
Acceptance Criteria covered:
Design §11.1
## 95. [ ] Revoke authenticated INSERT UPDATE dispatches
...
Acceptance Criteria covered:
Design §3.8
## 96. [ ] service_role only EXECUTE ingest checkout report reconcile
...
Acceptance Criteria covered:
Design §11.1
## 97. [ ] Enforce template_variables 8KB JSON Schema
...
Acceptance Criteria covered:
Design §11.4
## 98. [ ] Anti-corruption doc template_key only
...
Acceptance Criteria covered:
Design §11.6
## 100. [ ] Security test duplicate ingest
...
Acceptance Criteria covered:
Req.5 AC1
## 101. [ ] Security test stale report no-op
...
Acceptance Criteria covered:
Design §4.10
## 102. [ ] Concurrency test cancel vs checkout
...
Acceptance Criteria covered:
Req.4 AC3
## 103. [ ] Concurrency test 5 parallel checkout
...
Acceptance Criteria covered:
Req.3 AC1
## 104. [ ] Concurrency test parallel ingest quota
...
## 105. [ ] Load test ingest 50 RPS MVP
...
Acceptance Criteria covered:
Design §9.1
## 106. [ ] EXPLAIN ANALYZE queued poll index
...
Acceptance Criteria covered:
Design §9.2
## 107. [ ] Tune batch size and wall clock
...
Acceptance Criteria covered:
Design §5.5
## 108. [ ] Cron invoke interval minimum 15s
...
Acceptance Criteria covered:
Design §9.5
## 110. [ ] Growth stub audit partitioning
...
Acceptance Criteria covered:
§13.1
## 112. [ ] Orbit feature API ingest wrapper
...
Acceptance Criteria covered:
Req.4 AC2
## 114. [ ] Orbit client idempotency_key UUID v7
...
Acceptance Criteria covered:
Req.5 AC1 AC2
## 115. [ ] Orbit support audit timeline query
...
Acceptance Criteria covered:
Req.6 AC3
## 116. [ ] E2E email pipeline mock Resend
...
Acceptance Criteria covered:
Req.2 AC2
## 118. [ ] E2E Resend webhook reconcile
...
## 119. [ ] Rollout phase 1: DB + RPCs + cron (worker disabled)
...
## 120. [ ] Rollout phase 2: GA — worker, webhook, monitoring, rollback
