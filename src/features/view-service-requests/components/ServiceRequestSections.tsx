...
import { ServiceRequestPhotoGallery } from "./ServiceRequestPhotoGallery";

interface ServiceRequestSectionsProps {
...
export function ServiceRequestSections({
  description,
  formData,
  formSchema,
  photos,
}: ServiceRequestSectionsProps) {
    ...
    <div className="space-y-6">
      ...
      {photos.length > 0 && (
        <div>
          ...
          <div className="mt-2">
            <ServiceRequestPhotoGallery photos={photos} />
          </div>
        </div>
      )}
    </div>
