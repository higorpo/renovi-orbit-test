...
/** Row footer (Cancelar | Continuar) — payment / proposal shell dialogs. */
export const PAYMENT_DIALOG_FOOTER_ROW_CLASS = cn(
  PAYMENT_DIALOG_FOOTER_CHROME,
  "flex-row items-stretch",
  "[&>button]:h-auto [&>button]:min-h-10 [&>button]:flex-1 sm:[&>button]:h-10 sm:[&>button]:flex-none",
  "[&>a]:inline-flex [&>a]:h-auto [&>a]:min-h-10 [&>a]:flex-1 [&>a]:items-center [&>a]:justify-center sm:[&>a]:h-10 sm:[&>a]:flex-none",
);
