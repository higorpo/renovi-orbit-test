/**
 * Deferred payment-schedule fetch for the detail next-step card.
 * Mirrors my-services `useClientCardManualPayment` so schedule loads only after open.
 */
...
export function useClientCardManualPaymentBridge(contractedServiceId: string | null) {
