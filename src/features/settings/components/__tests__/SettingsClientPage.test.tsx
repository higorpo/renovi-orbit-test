...
describe("SettingsClientPage", () => {
  ...
  it("renders page title and subtitle", () => {
    render(<SettingsClientPage />, { wrapper: createWrapper() });
  ...
  it("renders skeletons while profile is loading", () => {
    ...
    const { container } = render(<SettingsClientPage />, { wrapper: createWrapper() });
  ...
  it("clears pending auto-save timer on unmount", async () => {
    ...
    const { unmount } = render(<SettingsClientPage />, { wrapper: createWrapper() });
