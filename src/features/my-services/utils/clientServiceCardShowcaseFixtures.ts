...
export function buildClientServiceCardShowcaseVariants(
  ...
  return [
    ...
    {
      id: "in-progress-payment-failed",
      label: "Pagamento falhou",
      description:
        "PENDING_PAYMENT com schedule FAILED_PERMANENT: alerta vermelho e CTA principal “Ajustar pagamento”.",
      group: "Em andamento",
      model: baseModel({
        id: "client-in-progress-payment-failed",
        listPhase: "in_progress",
        statusTabId: "in_progress",
        contractedServiceId: "cs-payment-failed",
        counterpartyName: "João Eletricista",
        counterparty: {
          id: "prov-joao",
          displayName: "João Eletricista",
        ...
        contracted: {
          ...
          chatId: "chat-payment-failed",
          updatedAt: now.toISOString(),
          paymentScheduleState: "FAILED_PERMANENT",
        },
        chatSummary: {
          id: "chat-payment-failed",
          isUnread: false,
          lastInteractionAt: addDays(now, -2).toISOString(),
          lastMessagePreview: null,
          providerDisplayName: "João Eletricista",
