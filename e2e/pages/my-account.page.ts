...
/** Minha conta (/dashboard/conta) — client and provider variants. */
export class MyAccountPage {
  ...
  async goto() {
    await this.page.goto("/dashboard/conta");
  }

  getPageHeading() {
    return this.page.getByRole("heading", { name: "Minha conta", level: 1 });
  }
...
export function getMyAccountClientCredentials() {
  return {
    email:
...
export function getMyAccountProviderCredentials() {
  return {
    email:
